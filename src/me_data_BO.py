...
class me_data_h_d(Dataset_2feat):
    ...
    """
    def __init__(self, posi_number,hop=3,distance=10,sitetype='K', **kwargs):
    ...
    def download(self):
        ...
        if True:
            ...
            # data_ori_path=f'../Result/BO/{self.sitetype}_site/'
            data_path=f'../dat/embedding_data/BO/{self.sitetype}/positive/'
            ...
            negative_num=0
            data_ori_path='../dat/graph_information/'
            data_path=f'../dat/embedding_data/BO/{self.sitetype}/negative/'
            matrixs_path=data_path+'adj/'
            feature_onehot_path=data_path+'feat_onehot/'
            feature_word2vec_path=data_path+'feat_word2vec/'
            seq_path=data_path+'seq/'
