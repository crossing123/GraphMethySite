...
# class me_data(Dataset_2feat):

#     """
#     A dataset of five random graphs.
#     """
#     def __init__(self, posi_number, **kwargs):
#         self.number=posi_number
#         # self.number_0=posi_number
#         self.class_name=self.__class__.__name__
#         self.save_path='../subgraph_information/embedding_model/'+self.class_name
#         self.output=[]
#         super().__init__(**kwargs)
#     def download(self):
#         hop=self.class_name.split('_')[1]
#         distances=self.class_name.split('_')[3] 
#         data_class=self.class_name.split('_')[4]
...
#             positive_num=0
#             data_ori_path='../subgraph_information/'
#             data_path=f'{data_ori_path}{hop}_hop_{distances}_{data_class}/positive/'
...
#             negative_num=0
#             data_ori_path='../subgraph_information/'
#             data_path=f'{data_ori_path}{hop}_hop_{distances}_{data_class}/negative/'
#             matrixs_path=data_path+'adj/'
#             feature_onehot_path=data_path+'feat_onehot/'
#             feature_word2vec_path=data_path+'feat_word2vec/'
#             seq_path=data_path+'seq/'
...
# class me_3_hop_10_K(me_data):
#     def __init__(self, posi_number=580, **kwargs):
#         super().__init__(posi_number=posi_number,**kwargs)


# class me_3_hop_10_R(me_data):
#     def __init__(self, posi_number=1816, **kwargs):
#         super().__init__(posi_number=posi_number, **kwargs)
...
class me_data_h_d(Dataset_2feat):
    ...
    def __init__(self, posi_number,hop,distance,sitetype, **kwargs):
        ...
        self.save_path=f"../subgraph_information/embedding_model/me_{hop}_hop_{self.distance}_{sitetype}"
        self.output=[]
        super().__init__(**kwargs)
    def download(self):
        data = ...  # Download from somewhere
